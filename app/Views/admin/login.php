...
<head>
  <meta charset="utf-8" />
  <title>ShopOnline Admin</title>
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta content="ShopOnline" name="description" />
  <meta content="Alejandro Vazquez" name="author" />

  <link rel="shortcut icon" href="<?php echo base_url('assets/images/shopIconFavicon.png'); ?>">
